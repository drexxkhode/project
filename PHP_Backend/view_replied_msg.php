...
if (isset($_GET['id'])) {
  ...
  $stmt = $con->prepare("SELECT id, clients_id, email, name, replied_message,replied_at FROM replies WHERE id = ?");
...
<head>
  ...
  <title>Nananomfarmsltd - Reply Messages </title>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="profile-header">
      ...
      <div>
        ...
        <p class="mb-1"><?= htmlspecialchars($user['replied_at']) ?></p>
