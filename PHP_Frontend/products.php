...
<div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
  ...
  <div class="portfolio-info">
    ...
    <a href="data:<?= $product['image_type'] ?>;base64,<?= base64_encode($product['image']) ?>" title="<?= htmlspecialchars($product['service_name']) ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i id="zoom" class="bi bi-zoom-in"></i></a>
